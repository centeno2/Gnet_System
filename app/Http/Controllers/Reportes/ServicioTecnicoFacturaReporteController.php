...
use App\Services\Reportes\ServicioTecnicoFacturaReporteService;

class ServicioTecnicoFacturaReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly ServicioTecnicoFacturaReporteService $servicioTecnicoFacturaReporteService,
    ) {
    ...
    {
        return $this->servicioTecnicoFacturaReporteService;
    }
}
