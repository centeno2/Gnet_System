...
use App\Services\Reportes\CreditosInstitucionalesReporteService;

class CreditosInstitucionalesReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly CreditosInstitucionalesReporteService $creditosInstitucionalesReporteService,
    ) {
    ...
    {
        return $this->creditosInstitucionalesReporteService;
    }
}
