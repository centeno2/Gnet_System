...
use App\Services\Reportes\StockProximoAgotarseReporteService;

class StockProximoAgotarseReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly StockProximoAgotarseReporteService $stockProximoAgotarseReporteService,
    ) {
    ...
    {
        return $this->stockProximoAgotarseReporteService;
    }
}
