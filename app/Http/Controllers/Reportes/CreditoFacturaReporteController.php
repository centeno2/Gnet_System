...
use App\Services\Reportes\CreditoFacturaReporteService;

class CreditoFacturaReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly CreditoFacturaReporteService $creditoFacturaReporteService,
    ) {
    ...
    {
        return $this->creditoFacturaReporteService;
    }
}
