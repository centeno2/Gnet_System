...
use App\Services\Reportes\VentasPeriodoReporteService;

class VentasPeriodoReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly VentasPeriodoReporteService $ventasPeriodoReporteService,
    ) {
    ...
    {
        return $this->ventasPeriodoReporteService;
    }
}
