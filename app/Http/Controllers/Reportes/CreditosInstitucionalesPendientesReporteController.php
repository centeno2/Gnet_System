...
use App\Services\Reportes\CreditosInstitucionalesPendientesReporteService;

class CreditosInstitucionalesPendientesReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly CreditosInstitucionalesPendientesReporteService $creditosInstitucionalesPendientesReporteService,
    ) {
    ...
    {
        return $this->creditosInstitucionalesPendientesReporteService;
    }
}
