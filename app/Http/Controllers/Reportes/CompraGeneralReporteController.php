...
use App\Services\Reportes\CompraGeneralReporteService;

class CompraGeneralReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly CompraGeneralReporteService $compraGeneralReporteService,
    ) {
    ...
    {
        return $this->compraGeneralReporteService;
    }
}