...
use App\Services\Reportes\InstalacionCamaraFacturaReporteService;

class InstalacionCamaraFacturaReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly InstalacionCamaraFacturaReporteService $instalacionCamaraFacturaReporteService,
    ) {
    ...
    {
        return $this->instalacionCamaraFacturaReporteService;
    }
}
