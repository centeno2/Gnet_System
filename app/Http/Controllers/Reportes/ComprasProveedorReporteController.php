...
use App\Services\Reportes\ComprasProveedorReporteService;

class ComprasProveedorReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly ComprasProveedorReporteService $comprasProveedorReporteService,
    ) {
    ...
    {
        return $this->comprasProveedorReporteService;
    }
}