...
use App\Services\Reportes\InventarioReporteService;

class InventarioReporteController extends BaseReporteController
{
    public function __construct(
        BasePdfReporteService $pdfService,
        BaseExcelReporteService $excelService,
        BaseWordReporteService $wordService,
        private readonly InventarioReporteService $inventarioReporteService,
    ) {
    ...
    {
        return $this->inventarioReporteService;
    }
}
